...
import net.biesek.bnetpdfviewer.applySystemBarMargins
import net.biesek.bnetpdfviewer.databinding.OutlineFragmentBinding
import net.biesek.bnetpdfviewer.viewModel.OutlineViewModel
